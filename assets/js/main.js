...
const products = [
  {
    ...
    price: 100,
    image: 'https://compreteo.com/wp-content/uploads/2017/02/macetas-apiladas.jpg',
  ...
  },
  {
    ...
    name: 'Product 2',
    price: 200,
    image: 'https://jardin10.com/wp-content/imagenes/las-mejores-macetas-colgantes.jpg',
    description: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, quidem.'
  },
  {
    id: 3,
    name: 'Product 3',
    price: 300,
    image: 'https://i.pinimg.com/originals/a1/6b/15/a16b1529a20ac994a937e6fac6396fa0.jpg',
    description: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, quidem.'
  }
]
...
for (let product of products) {
  ...
  <div class="wrapper__product">
    <div class="wrapper__product-img">
      <img style="width: 250px" src="${product.image}" alt="${product.name}" class="wrapper__product-img-item">
    </div>
